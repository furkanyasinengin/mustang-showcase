...
Command: npx gltfjsx@6.5.3 public/mustang.glb 
...
export function Model(props) {
  ...
  useLayoutEffect(() => {
    // arabanın ana gövde, kapı boyası
    if (materials.Color_04) {
      materials.Color_04.color.set(props.color || "#173f5f");
    }
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <group
        position={[0.106, 0.153, 0.278]}
        rotation={[-1.03, 0, 0]}
        scale={[0.012, 0.029, 0.026]}
      >
      ...
      <mesh
        ...
        material={materials.Carpet}
        position={[0.161, 0.111, 0.079]}
        rotation={[0.002, 0, 0]}
        scale={[0.089, 0.089, 0.161]}
      />
      <mesh
        geometry={nodes.Object_231.geometry}
        material={materials.Carpet}
        position={[-0.158, 0.111, 0.079]}
        rotation={[0.002, 0, 0]}
        scale={[0.089, 0.089, 0.161]}
      />
      <mesh
      ...
      <mesh
        ...
        material={materials.Metal_Part}
        position={[0, 0.211, 0.162]}
        scale={0.003}
      />
      <mesh
        geometry={nodes.Object_244.geometry}
        material={materials["Material.002"]}
        position={[0.467, 0, 0.004]}
        rotation={[0, 0, 1.605]}
        scale={0.134}
      />
    </group>
